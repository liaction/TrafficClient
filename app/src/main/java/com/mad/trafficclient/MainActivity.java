...
import com.mad.trafficclient.fragment.ETCFragment;
import com.mad.trafficclient.fragment.Fragment20;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tV_title.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                getSharedPreferences("tc", Context.MODE_PRIVATE).edit().remove("auto").apply();
                Toast.makeText(MainActivity.this, "取消自动登录成功", Toast.LENGTH_SHORT).show();
                return true;
            }
        });
        ...
        listView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
                hideSlidepanel();
                if (mCurrentIndex == arg2) {
                    return;
                }
                mCurrentIndex = arg2;
                switch (arg2) {
                    case 0:
                        getSupportFragmentManager().beginTransaction().replace(R.id.maincontent, new Fragment20()).commit();
